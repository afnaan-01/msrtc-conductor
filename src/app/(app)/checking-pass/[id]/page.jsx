  ...
  return (
    <div className="main flex flex-col gap-6">
      ...
      <section className='absolute bottom-0'>
        <div className='flex flex-row gap-6 action-button-container w-full'>
          <button
            className='bg-green-500 p-3 rounded-md text-xs text-white font-bold w-2/5'
            onClick={(e) => { e.preventDefault(); handleSelectGoing() }}>Select For Going</button>
          <button
            className='bg-red-500 p-3 rounded-md text-xs text-white font-bold w-2/5'
            onClick={(e) => { e.preventDefault(); handleSelectComming() }}>Select For Coming</button>
        </div>
      </section>
    </div>
  );
